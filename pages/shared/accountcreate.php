...
<body>
    ...
    <div id="pagecontent">
        ...
        <form novalidate id="register" class="container" method="POST" action="accountcreate.php";>
            ...
            <input class="button buttongreen" type="submit" value="Create" onlclick = "myFunction(value1)"> <br />
        </form>
